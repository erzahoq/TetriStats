...
const { formatNumber, escapeUnderscores, getEmojiOfAch, reformatTimestamp, convertToTimeFormat, buildReplayStatComparisonString } = require('../../helpers/functions');
...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription('Analyse a user\'s achievements on TETR.IO.')
    ...
    async execute(interaction) {
        ...
        //delete this pls dont forget :aysm:
        let st = await database.LeagueStat.findByPk(`achievements/Stacker`);
        console.log(st)

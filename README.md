...
![An image of a user's stats from the bot.](github-images/image.png)
...
![An example of comparing two users with the /compare command.](github-images/image-1.png)

### 🔍 Tetra League Insight

Get current data on a player’s current TR, Glicko rating, rank, and league performance. 

![The /league command showing information about a user.](github-images/image-2.png)
...
![Image of the /news-top command showing the latest news about badges and world records](github-images/image-3.png)
...
![The /server-stats command showing a bunch of information about the current TETR.IO servers.](github-images/image-4.png)
